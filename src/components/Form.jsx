  ...
  return (
    <div id="contact" className='form-container '>
        <form className='overlay-contact flex flex-col items-center gap-y-4 p-6 bg-gray-100' action='#'>
          ...
          <a className="text-2xl bg-orange-400 px-6 py-2 rounded-md cursor-pointer text-white font-bold hover:bg-orange-500 transition delay-50" href="mailto:contact.globalcert@gmail.com">contact.globalcert@gmail.com</a>
        </form>
