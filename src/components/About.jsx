...
const About = () => {
    ...
    return (
        <div id='about' className="about flex flex-col gap-y-2 justify-center items-center text-center p-8">
            <h1 className='animate__animated animate__backInLeft font-bold text-4xl pt-6 pb-4'>WHY CORPORATE INITIATION PROGRAM ?</h1>
            <blockquote className='w-4/5  text-2xl text-gray-500 italic'>
            "Corporate Initiation Program" or in short "CIP" is a program designed to benefit the high school and 
            college students to get insights about their career and have an idea on their career path in the future. 
            The program has been developed by eduation experts in Singapore to help the students have clarity over their career options 
            and path by gaining first hand industry experience & inisghts in order to take a well informed career decision."
            </blockquote>
            ...
            <div className={`${flip1 ? "flipped" : ""} card-container flex flex-col gap-y-2 items-center w-1/4 border-4 rounded-md px-4 py-2 justify-center content`} onMouseEnter={changeFlip1} onMouseLeave={changeFlip1}>
                <div className="front">
                    ...
                    <h1 className='font-bold text-2xl text-center'>Confusion over Plethora of Career Options</h1>
                </div>
