const Timeline = () => {
  return (
    <div id="schedule">
        <h1 className="text-center font-bold text-4xl pt-10 mb-4">CORPORATE INITIATION PROGRAM SCHEDULE</h1>
        {/*<h2 className="text-center text-gray-500 text-md mb-4 italic"> Lorem ipsum dolor sit amet consectetur</h2>*/}
        {/* circle-1 */}
