  ...
  return (
    <div>
      ...
      <div className={`${navbarColor ? 'bg-white' : 'bg-transparent'} nav-container flex justify-between p-4 w-full fixed top-0 z-20`}>
        {/*<a href="/" className="logo text-orange-500 bg-gray-200 px-4 py-2 rounded-md font-bold cursor-pointer">CIP</a>*/}
        <a href="/"><img src={require("../assets/image/CIP-logo.png")} alt="pic" width={110} height={100} className="logo"/></a>
          <div className="links flex justify-end text-xl text-white items-center gap-x-14 pr-6 font-bold">
            ...
            <Link to="run1" smooth={true} duration={50} offset={-200}  spy={true} className="text-orange-500 cursor-pointer">Runs</Link>
