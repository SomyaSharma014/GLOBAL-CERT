...
const Run = () => {
    ...
    return (
        <div className='bg-gray-100'>
            ...
            {/*<button className="bg-orange-300 px-4 py-2 rounded-md text-white outline-none hover:bg-orange-500 transition delay-50 focus:bg-orange-500" onClick ={() => setVisible(isVisible = 2)}>Run 2</button>
            <button className="bg-orange-300 px-4 py-2 rounded-md text-white outline-none hover:bg-orange-500 transition delay-50 focus:bg-orange-500" onClick ={() => setVisible(isVisible = 3)}>Run 3</button>*/}
            </section>
